...
case "$(echo "$SYS" | tr '[:upper:]' '[:lower:]')" in
    *debian*|*astra*) SYSTEM="Debian"; PACKAGE_INSTALL="apt-get -y install" ;;
    *ubuntu*) SYSTEM="Ubuntu"; PACKAGE_INSTALL="apt-get -y install" ;;
    *centos*|*red*hat*|*kernel*|*oracle*linux*|*alma*|*rocky*) SYSTEM="CentOS"; PACKAGE_INSTALL="yum -y install" ;;
    *amazon*linux*) SYSTEM="CentOS"; PACKAGE_INSTALL="yum -y install" ;;
    *fedora*) SYSTEM="Fedora"; PACKAGE_INSTALL="yum -y install" ;;
    *arch*) SYSTEM="Arch"; PACKAGE_INSTALL="pacman -Sy --noconfirm --needed" ;;
    *freebsd*) SYSTEM="FreeBSD"; PACKAGE_INSTALL="pkg install -y" ;;
    *alpine*) SYSTEM="Alpine"; PACKAGE_INSTALL="apk add" ;;
    *openbsd*) SYSTEM="OpenBSD"; PACKAGE_INSTALL="pkg_add" ;;
    *) SYSTEM="Unknown"; PACKAGE_INSTALL="" ;;
esac
...
download_speedtest_file() {
    ...
    if ! command -v speedtest >/dev/null 2>&1; then
        ...
        if [ "$speedtest_ver" = "1.2.0" ]; then
            ...
            url1="https://filedown.me/Linux/Tool/speedtest_cli/ookla-speedtest-1.0.0-${sys_bit}-linux.tgz"
            url2="https://bintray.com/ookla/download/download_file?file_path=ookla-speedtest-1.0.0-${sys_bit}-linux.tgz"
        fi
        ...
        url3="https://github.com/showwin/speedtest-go/releases/download/v${speedtest_go_version}/speedtest-go_${speedtest_go_version}_Linux_${sys_bit}.tar.gz"
